        ...
        if dirname != '':
            ...
            for i in dataDocumentArray[1:]:
                ...
                if comprobanteType == 'Comprobante de Retención':
                    ...
                    c.setFont("Helvetica", 8)
                    c.setFillColorRGB(0,0,0)
                    message = 'Razón Social/Nombres                                  '+ arrayData[12]
                    c.drawString((0.3)*inch, (6.3)*inch, message)

                    message = 'Identificacion                 '+ arrayData[15]
                    c.drawString((0.3)*inch, (6.1)*inch, message)

                    message = 'Fecha                            '+ arrayData[11]
                    c.drawString((0.3)*inch, (5.9)*inch, message)
                    
                    # CREACION DE LA TABLA CON LOS COMPROBANTES
                    ...
                    for index, item in enumerate(arrayData[16]):
                        data.append(item)
                        print(item)
                        table = Table(data, colWidths=[70, 90, 70, 50, 80, 80, 50, 70,50])
                        table.canv = c
                        w, h = table.wrap(0,0)
                        ...
                        if (h > 390 and pagina == 0 and index != 0 ):
                            ...
                            table = Table(auxiliar, colWidths=[70, 90, 70, 50, 80, 80, 50, 70,50])
                            table.canv = c
                            table.setStyle([("VALIGN", (0,0), (-1,-1), "MIDDLE"),
                                    ("ALIGN", (0,0), (-1,-1), "CENTER"),
                                    ('INNERGRID', (0,0), (-1,-1), 1, colors.black),
        ...
        if tipoComp == 2: 
            ...
            if impuestos is not None:
                ...
                for child in impuestos.findall('impuesto'):
                    ...
                    ejeFiscal = ''
                    arrayImpuesto.append(ejeFiscal)
